...
class OpenAIController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $chatHistory[] = ['role' => 'system', 'content' => $this->GptName];
        $chatHistory[] = ['role' => 'system', 'content' => $this->GptSystem];
        ...
        ->post("https://api.openai.com/v1/chat/completions", [
            "model" => $this->GptModel,  // Modelo de GPT utilizado para generar respuestas
        ...
        $voiceFilePath = $this->crea_el_archivo_de_voz($response, $this->GptVoice, $this->elevenApiKey, $request);
